...
Usage:
    python switch_env.py development   # Switch to development environment
    python switch_env.py production    # Switch to production environment
    python switch_env.py test          # Test current database connection
    python switch_env.py --help        # Show help message
"""
